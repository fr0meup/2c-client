  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="relative flex max-h-[90vh] w-full flex-col overflow-hidden rounded-t-3xl border border-white/[0.08] bg-[#141410] shadow-2xl shadow-black/60 sm:max-h-[85vh] sm:max-w-md sm:rounded-3xl"
      >
        {/* Header */}
